...
public class BasePage {
    ...
    public void checkToCheckboxOrRadiobox(WebDriver driver, String locator){
    ...
    public void screenshotElement(WebDriver driver, String destFolder, String locator){
        WebElement elementScreenshot = getElement(driver, locator);
        File source = elementScreenshot.getScreenshotAs(OutputType.FILE);
    ...
    public void screenshotSection (WebDriver driver, String destFolder, String sourceLocator, String destLocator){
        WebElement sourceElement = getElement(driver, sourceLocator);
        sourceElement.click();

        waitForElementVisible(driver, destLocator);
        WebElement destElement = getElement(driver, destLocator);
        scrollToElement(driver, destLocator);
        File source = destElement.getScreenshotAs(OutputType.FILE);
        File dest = new File(destFolder);
        try{
            FileHandler.copy(source,dest);
        } catch (IOException exception) {
    ...
    public void screenshotFullPageScreen(WebDriver driver, String destFolder){
        File source = ((FirefoxDriver)driver).getFullPageScreenshotAs(OutputType.FILE);
        try {
            FileHandler.copy(source, new File(destFolder));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public void screenshotPageScreen(WebDriver driver, String destFolder){
